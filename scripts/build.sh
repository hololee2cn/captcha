...
Examples:
    ./build.sh test -v -count=1 -e redis_host_port=10.25.3.125:6379 -e redis_db=1 -e redis_pw=123456
    ./build.sh run  -e redis_host_port=10.25.3.125:6379 -e redis_db=1 -e redis_pw=123456
EOF
}
